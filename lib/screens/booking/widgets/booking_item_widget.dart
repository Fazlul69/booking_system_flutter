    ...
    Widget _buildEditBookingWidget() {
      if (data.status == BookingStatusKeys.pending && DateTime.parse(data.date.validate()).isAfter(DateTime.now())) {
        return Column(
          children: [
            16.height,
            ic_edit_square.iconImage(size: 20).onTap(
              () {
                showInDialog(
                  context,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          16.height,
          if (data.status == BookingStatusKeys.pending)
            Row(
          ...
          Row(
            ...
            children: [
              ...
              8.width,
              if (data.status != BookingStatusKeys.pending) Text('#' + data.id.validate().toString(), style: boldTextStyle(color: primaryColor, size: 20)),
            ],
          ),
          // 16.height,
          8.height,
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Spacer(),
                    Text("${data.provider_name.validate()}", style: primaryTextStyle(), maxLines: 1, overflow: TextOverflow.ellipsis),
                  ],
                ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Spacer(),
                          Text(data.handyman!.first.handyman!.display_name.validate(), style: primaryTextStyle(), maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.right),
                        ],
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Spacer(),
                          Text(getPaymentStatusText(data.payment_status), style: primaryTextStyle(color: data.payment_status.validate() == SERVICE_PAYMENT_STATUS_PAID ? Colors.green : Colors.red)),
                        ],
                      ),
                      Divider(),
                      Row(
