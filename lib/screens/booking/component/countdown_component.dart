...
class _CountdownWidgetState extends State<CountdownWidget> {
  ...
  void initState() {
    if (widget.bookingDetailResponse.booking_detail!.status.validate() == BookingStatusKeys.inProgress) {
      value = "${(widget.bookingDetailResponse.booking_detail!.durationDiff.toInt() + DateTime.now().difference(DateTime.parse(widget.bookingDetailResponse.booking_detail!.startAt.validate())).inSeconds)}".toInt();
      stopTimer = false;
      init();
    } else {
