      ...
      children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: data.isFavourite == 1 ? ic_fill_heart.iconImage(color: favouriteColor, size: 24) : ic_heart.iconImage(color: unFavouriteColor, size: 24),
          ).onTap(() async {
      ...
      child: Stack(
        ...
        children: [
          if (data.description.validate().isNotEmpty)
            ...
            ).paddingOnly(top: 116, bottom: 0, left: 16, right: 16)
          else
              ...
              child: Column(
                ...
                children: [
                  if (data.subCategoryName.validate().isNotEmpty)
                    Text('${data.categoryName} > ${data.subCategoryName}', style: boldTextStyle(size: 14, color: primaryColor))
                  else
                  ...
                  TextIcon(
                    ...
                    suffix: Row(
                      children: [
                        Icon(Icons.star, color: ratingBarColor, size: 20),
                        4.width,
