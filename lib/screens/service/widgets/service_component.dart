              ...
              children: [
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: PriceWidget(price: widget.serviceData!.price.validate(), isHourlyService: widget.serviceData!.type.validate() == SERVICE_TYPE_HOURLY, color: Colors.white, hourlyTextColor: Colors.white),
                  ),
                ),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
