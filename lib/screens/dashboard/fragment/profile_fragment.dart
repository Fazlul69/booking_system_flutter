                  ...
                  children: [
                    ...
                    SettingSection(
                      ...
                      items: [
                        ...
                        ).visible(appStore.isLoggedIn && isLoginTypeUser),
                        SettingItemWidget(
                        ...
                        SettingItemWidget(
                          ...
                          trailing: trailing,
                          onTap: () {
                            FavouriteListScreen().launch(context, pageRouteAnimation: PageRouteAnimation.Slide);
                          },
                        ).visible(appStore.isLoggedIn),
                        SnapHelperWidget(
                          future: isAndroid12Above(),
                          onSuccess: (data) => SettingItemWidget(
                            leading: 'images/icons/ic_android_12.png'.iconImage(size: iconSize),
                            title: 'Enable Material You Theme',
                            trailing: Switch(
                              ...
                              onChanged: (v) {
                                ...
                                }, title: 'This action will restart your app. Confirm?', primaryColor: context.primaryColor);
                              },
                            ).withHeight(24),
                            onTap: null,
                          ),
                        ...
                        SettingItemWidget(
                          ...
                          onTap: () async {
                            PackageInfo.fromPlatform().then((value) {
                              ...
                              launchUrl('${isAndroid ? playStoreUrl : appStoreBaseUrl}$package');
                            });
                          },
                        ),
                      ],
                        ...
                        SettingItemWidget(
                          ...
                          onTap: () {
                            if (appStore.helplineNumber.isNotEmpty) {
                              ...
                              toast(language!.lblNotAvailableNumber);
                            }
                          },
                        ),
                        SettingItemWidget(
